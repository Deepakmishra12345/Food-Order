...
class CustomerHomePage(BackgroundPage):
    ...
    def add_menu(self):
        ...
        self.menu_frame = Frame(self.panel, height=520, width=600, bg="white")
        self.menu_frame.place(x=600, y=150)
    ...
    def add_menu_items(self, food_type):
        ...
        self.menu_items_frame = SimpleTable(self.menu_frame, rows=len(result), columns=len(result[0]), height=400,
                                            width=500)
